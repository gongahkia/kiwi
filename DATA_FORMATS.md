...
`KWI-STATE\0` version `14` is the canonical mission-state payload. It uses a
...
exact payload. Decoders reject versions `1` through `13`, unsupported versions,
...
`KWI-STATE\0`, 16-bit format version `14`, tick, phase, entities, optional map
...
bounded magazines, and entity-ID-ordered nonzero aim qualities,
...
intentionally unsupported. Versions `5` through `13` are also intentionally
