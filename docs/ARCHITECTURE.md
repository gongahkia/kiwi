...
Kitty graphics remains outside the parser/state implementation. Its future
bounded APC-G action, opaque transfer/placement ledger, error cases, and strict
terminal/decoder/renderer ownership boundary are specified before allocation in
[KITTY_GRAPHICS.md](KITTY_GRAPHICS.md) and [ADR 0033](adr/0033-kitty-graphics-parser-state-foundation.md).
