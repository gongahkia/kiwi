...
function Snapshot.value(state)
  ...
  return {
    ...
    modes = {
      ...
      backarrow = state.modes.backarrow,
      autowrap = state.modes.autowrap,
      reverse_wrap = state.modes.reverse_wrap,
      bracketed_paste = state.modes.bracketed_paste,
      cursor_style = state.modes.cursor_style,
      cursor_blink = state.modes.cursor_blink,
      cursor_visible = state.modes.cursor_visible,
      focus_reporting = state.modes.focus_reporting,
      insert = state.modes.insert,
      newline = state.modes.newline,
      keyboard_flags = state.modes.keyboard_flags,
      modify_other_keys = state.modes.modify_other_keys,
      alternate_scroll = state.modes.alternate_scroll,
      mouse_pixels = state.modes.mouse_pixels,
    ...
    pointer_shape = state.pointer_shape,
